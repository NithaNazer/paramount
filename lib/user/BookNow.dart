...
class HouseBooking extends StatelessWidget {
  String typeid;
  String type;
String houseid;

   HouseBooking({super.key,required this.typeid,required this.type,required this.houseid});
                  ...
                  builder: (context,value,child) {
                    return Container(
                      ...
                      child:Center(child: InkWell(
                          onTap:(){
                            value.ADDDETAIL(context,type,typeid,houseid);
                            value.bookingclear();
