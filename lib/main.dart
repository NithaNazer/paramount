...
import 'package:project/user/About%20us.dart';
import 'package:project/user/BottomNavigation.dart';
...
import 'package:project/user/housedetails.dart';


import 'package:project/user/profile.dart';
import 'package:project/user/signup.dart';
import 'package:project/user/splash.dart';
import 'package:provider/provider.dart';

import 'admin/AdminLists.dart';
import 'admin/Booked.dart';
import 'admin/Homepage.dart';
import 'admin/More info.dart';
import 'admin/PropDetaiilsAdm.dart';
import 'admin/addhouse.dart';
import 'admin/conventadd.dart';
import 'admin/Requests.dart';
import 'admin/TypeAdd.dart';
import 'admin/Types.dart';
import 'admin/Users.dart';
import 'admin/buyand rentadd.dart';
import 'admin/addplot.dart';
