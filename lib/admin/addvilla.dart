...
//
// class addvilla extends StatelessWidget {
//   String from;
//   String oldid;
//   addvilla({super.key,required this.from,required this.oldid});
...
//                   onTap: () => {
//                     mainprovider.getIImgcamerasvilaa(), Navigator.pop(context)
//                   }),
//               ListTile(
//                   leading:  Icon(Icons.photo, color: Colors.blue),
//                   title: const Text('Gallery',),
//                   onTap: () => {
//                     mainprovider.getIImggalleryvilla(),Navigator.pop(context)
//                   }),
//             ],
//           );
//         });
